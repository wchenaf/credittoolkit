...
<html>
  <head>
    ...
    <link href="../pages/css/pages.css" rel="stylesheet" type="text/css" media="screen" />
    <!-- Datatables -->
  ...
  <body class="fixed-header menu-pin menu-behind"> 
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-header">
        <img src="../assets/img/logo-small.png" alt="logo" class="brand" data-src="../assets/img/logo-small.png" data-src-retina="../assets/img/logo-large.png" href = "screener.php" width="160" height="33">
      </div>
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          <li class="m-t-30">
            <a href="screener.php" >
              <span class="title">Bond Search</span>
            </a>
            <span class="icon-thumbnail "><i class="fa fa-search"></i></span>
          </li>
          <li class="">
            <a href="old-screener.php" >
              <span class="title">SQL Bond Search</span>
            </a>
            <span class="icon-thumbnail "><i class="fa fa-database"></i></span>
          </li>
          <li class="">
            <a href="comparables.php">
              <span class="title">Comparables</span>
            </a>
            <span class="icon-thumbnail "><i class="fa fa-rocket"></i></span>
          </li>
        </ul>
      ...
      <div class="header ">
        ...
        <div class="">
          <div class="brand inline   ">
            <img src="../assets/img/logo-large.png" alt="logo" data-src="../assets/img/logo-large.png" data-src-retina="../assets/img/logo-large.png" href = "screener.php" width="160" height="33">
          </div>
                      ...
                      <div class="notification-item unread clearfix">
                        ...
                        <div class="heading open">
                          <a href="#" class="text-complete pull-left">
                            ...
                            <span class="fs-12 m-l-10">Eric Chiang</span>
                          </a>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="pull-left p-r-10 fs-14 font-heading hidden-md-down">
            <span class="semi-bold">Eric</span> <span class="text-master">Chiang</span>
          </div>
