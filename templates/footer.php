...
<div class="container-fluid container-fixed-lg footer">
    ...
    <!-- START OVERLAY -->
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="../assets/img/logo-small.png" alt="logo" data-src="../assets/img/logo-small.png" data-src-retina="../assets/img/logo-large.png" width="80" height="17">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
    ...
    <script src = "../custom-js/slider_config.js" type="text/javascript"></script>
